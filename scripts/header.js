class Header extends HTMLElement {
  ...
  connectedCallback() {
    ...
    <img class="mobile-logo hover" src="assets/reanna-chambers-logo.svg" style="height: 15px; margin-top: 10px;"  alt="logo" onclick="window.open('/ReannaChambers', '_self')"/>
      <nav class="flex-center-spaceevenly">
          ...
          <img src="assets/reanna-chambers-logo.svg" class="desktop-logo hover" alt="logo" onclick="window.open('/ReannaChambers', '_self')"/>
